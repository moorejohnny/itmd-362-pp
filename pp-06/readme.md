...
2. Write the name of your group members here: Cesar Escoto, Roman Francisco, Paul Perumalla
...
Write the URL for your personal fork of the repository here: https://github.com/moorejohnny/project2
...
group	git@github.com:scarlethawks/project2.git (fetch)
group	git@github.com:scarlethawks/project2.git (push)
origin	git@github.com:moorejohnny/project2.git (fetch)
origin	git@github.com:moorejohnny/project2.git (push)
...
Write the URL of your pull request here: https://github.com/scarlethawks/project2/pull/15
